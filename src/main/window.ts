	...
	function runAntiPro(): void {
		...
		mainWindow.webContents.executeJavaScript(`(function(){
			...
			try{
				...
				hideDemoButton();
				replaceLoginLogo();
				setTimeout(replaceLoginLogo, 1000);
